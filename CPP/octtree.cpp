...
void encodeAndPrintBlocks(Node *node, const int &ox, const int &oy, const int &oz,
                          const int &size_x, const int &size_y, const int &size_z, std::unordered_map<char, std::string> &tags)
{
    /*
   ...
   */
    ...
    else
    {
        ...
        encodeAndPrintBlocks(node->children[1], ox + hx, oy, oz, size_x - hx, hy, hz, tags);
        encodeAndPrintBlocks(node->children[2], ox, oy + hy, oz, hx, size_y - hy, hz, tags);
        encodeAndPrintBlocks(node->children[3], ox + hx, oy + hy, oz, size_x - hx, size_y - hy, hz, tags);
        if (size_z > 1)
        {
            encodeAndPrintBlocks(node->children[4], ox, oy, oz + hz, hx, hy, size_z - hz, tags);
            encodeAndPrintBlocks(node->children[5], ox + hx, oy, oz + hz, size_x - hx, hy, size_z - hz, tags);
            encodeAndPrintBlocks(node->children[6], ox, oy + hy, oz + hz, hx, size_y - hy, size_z - hz, tags);
            encodeAndPrintBlocks(node->children[7], ox + hx, oy + hy, oz + hz, size_x - hx, size_y - hy, size_z - hz, tags);
        }
    }
}
